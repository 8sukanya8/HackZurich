...
public class CheckPictureActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        takePicButton.setOnClickListener(new CheckPictureActivity.onclickiness());
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == REQUEST_IMAGE_CAPTURE && resultCode == RESULT_OK) {
            ...
            CheckPictureActivity.VisionHelper helper = new CheckPictureActivity.VisionHelper();
    ...
    public class VisionHelper {
        ...
        public void makeRequest(Context context, final Bitmap image){
            ...
            CheckPictureActivity.VisionHelper.NeededThings neededThings = new CheckPictureActivity.VisionHelper.NeededThings(context, vision, image);
            CheckPictureActivity.visionCaller caller = new CheckPictureActivity.visionCaller();
            caller.execute(neededThings);
        }

    }

    class visionCaller extends AsyncTask<CheckPictureActivity.VisionHelper.NeededThings, Void, List<String>> {
        Context context;
        @Override
        protected List<String> doInBackground(CheckPictureActivity.VisionHelper.NeededThings... neededThingses) {
            byte[] photoData;
        ...
        protected void onPostExecute(List<String> items) {
            ...
            Intent i = new Intent(getApplicationContext(), CheckResponseActivity.class);
